  ...
  <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <span class="close-modal" @click="closeModal" style="color: red"
          >&times;</span
        >
      </div>
      <div class="form-row">
      ...
      <div style="margin-top: 10px; text-align: left">
        <button
          @click="isEditMode ? editSiswa() : addSiswa()"
          class="btn_add_siswa"
        >
    ...
    <div class="import-search-wrapper">
      ...
      >
        <div class="modal-content">
          ...
          <div style="margin-top: 10px; text-align: left">
            <button @click="submitExcelData" class="btn-add-bengkel">
              Submit
            </button>
          </div>
        </div>
          ...
          <tr v-for="(siswa, index) in paginatedSiswaList" :key="index">
            ...
            <td>
              <div class="action-set">
                ...
                <button
                  class="dropdown-item"
                  @click="deleteSiswa(siswa.nomorInduk)"
                  style="color: red"
                >
...
export default {
  ...
  methods: {
    ...
    validateSiswaForm() {
      const { nomorInduk, nama, jenisKelamin, jurusan } = this.newSiswa;
