        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <select
              ...
              v-model="newPeminjaman.id_alat"
              :disabled="isEditMode"
            >
              <option disabled value="">Pilih Alat Dipinjam</option>
              <option
          ...
          <div class="form-group-nama">
            ...
            <select
              ...
              v-model="newPeminjaman.nisPeminjam"
              :disabled="isEditMode"
            >
          ...
          <td>
            ...
            <div class="dropdown d-inline-block">
              ...
              >
                ...
                <button
                  class="dropdown-item"
                  @click="confirmDelete(index, peminjaman)"
                  style="color: red"
                >
                  Hapus
                </button>
          ...
          <div v-if="selectedOption === 'bermasalah'">
            ...
            <div class="form-row">
              ...
              <div class="form-group" style="margin-left: 0.3rem">
                <label for="jumlahAlatRusak" style="font-size: 0.9rem"
                  >Jumlah</label
                >
                <label
                  for="jumlahAlatRusak"
            ...
            <!-- form row bawah -->
            <button
              @click="addPengembalianBermasalah"
...
export default {
  ...
  methods: {
    ...
    // async fetchDataBengkel() {
    //   try {
    //     const response = await axios.get("http://localhost:3000/bengkel");

    //     // Periksa apakah respons berhasil
    //     if (response.status === 200 && response.data.status === "success") {
    //       // Simpan data yang diterima ke dalam bengkelList
    //       this.bengkelList = response.data.data;
    //     } else {
    //       throw new Error("Gagal memuat data bengkel.");
    //     }
    //   } catch (error) {
    //     Swal.fire({
    //       title: "Error!",
    //       text: `Tidak dapat memuat data bengkel: ${error.message}`,
    //       icon: "error",
