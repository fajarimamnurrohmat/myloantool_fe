...
export default {
  ...
  methods: {
    ...
    editPeminjaman(peminjaman) {
      ...
      // Pastikan tanggal dalam format yang sesuai
      const tanggalPinjam = new Date(
        peminjaman.tanggal_pinjam
      ).toLocaleDateString("en-CA"); // Format yyyy-mm-dd

      this.newPeminjaman = {
        id_peminjaman: peminjaman.id_peminjaman, // Tambahkan id_peminjaman
