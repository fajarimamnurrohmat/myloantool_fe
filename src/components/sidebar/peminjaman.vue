...
<div class="filter-wrapper">
    ...
    <div class="date-inputs">
        ...
        <div class="filter-buttons">
            <button @click="resetFilter" class="btn-reset" style="
              height: 2.7rem;
              width: 3rem;">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu-exports" :class="{ show: dropdownIndex === index }">
                    <a class="dropdown-item-export" @click="exportData('pdf')" style="color: #4b6cb7;"><i class="fa fa-file-pdf" aria-hidden="true" style="
                        margin-left: 0.5rem;
                        margin-right: 0.1rem;">
                        </i>
                        .pdf
        ...
        <div class="search-bar-container">
            ...
            <input type="text" v-model="searchQuery" class="search-input" style="padding-right: 30px;
                  width: 13rem;" placeholder="Cari data..." />
        </div>
        <!-- search -->
    </div>
                ...
                <td>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu-act" :class="{ show: dropdownIndex === index }">
                            <button class="dropdown-item" @click="editPeminjaman(index)" style="color: #274278">Edit</button>
                            <button @click="openPengembalianModal(peminjaman)" class="dropdown-item" style="color: #274278">Pengembalian</button>
                            <button class="dropdown-item" @click="confirmDelete(index)" style="color: red">Hapus</button>
                        </div>
                    </div>
                    <!-- dropdown set -->
                </td>
    ...
    methods: {
        ...
        async addPengembalian() {
            ...
            if (
              ...
              this.newPeminjaman.tanggalPinjam &&
                ...
                axios.post('http://localhost:3000/pengembalian', data)
                    .then(response => {
        ...
        async addPengembalianBermasalah() {
            try {
                ...
                const response = await axios.post('http://localhost:3000/alat-bermasalah', {
                    ...this.newPeminjaman,
                    tanggalPengembalian: this.newPengembalian.tanggalPengembalian,
                ...
                if (response.status === 200) {
                    Swal.fire("Sukses!", "Data pengembalian bermasalah berhasil disimpan.", "success");
                    this.closeModal();
                    this.resetForm();
                    this.$router.push({
                        name: "databermasalah"
        ...
        openPengembalianModal(peminjaman) {
            this.newPeminjaman = {
                ...peminjaman
            }; // Salin data peminjaman ke newPeminjaman
...
.button-row {
    ...
    flex-wrap: wrap;
    /* If you want the buttons to wrap on smaller screens */
    margin-bottom: 1rem;
}
